...
try {
  contextBridge.exposeInMainWorld('api', {
    ...
    searchModels: (query: string, kind?: string) =>
    ...
    artifactRuntime: (kind: 'html' | 'svg' | 'mermaid' | 'react') =>
      ipcRenderer.invoke('artifacts:runtime', kind),
    ...
    crmRenameEntity: (id: number, name: string) =>
      ipcRenderer.invoke('crm:rename-entity', id, name),
    crmRetypeEntity: (id: number, type: string) =>
      ipcRenderer.invoke('crm:retype-entity', id, type),
    ...
    crmDayJournalCached: (startSec: number) =>
      ipcRenderer.invoke('crm:day-journal-cached', startSec),
    ...
    idSet: (id: { name?: string; email?: string; emails?: string[] }) =>
