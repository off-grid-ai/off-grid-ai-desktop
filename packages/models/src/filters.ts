...
export function applySort<T extends FilterableModel>(models: T[], sort: SortOption, ramGb = 0): T[] {
...
export function filterAndSort<T extends FilterableModel>(models: T[], state: FilterState, ramGb = 0): T[] {
